                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h6 class="card-title text-center">RELAX OUT</h6>
                                </div>
        ...
        $(function() {
            ...
            var table = $('#cbdTable').DataTable({
                ...
                columns: [{
                        ...
                        "render": function(data, type, row) {
                            if (Array.isArray(row.item_details) && row.item_details.length > 0) {
                                ...
                                row.item_details.forEach(function(item) {
                                    original_nos += (item.original_no ? '<li>' + item
                                        .original_no + '</li>' :
                                        '');
                                });
                                original_nos += '</ul>';
                    ...
                    //             var items = '<ul>';
                    //             row.item_details.forEach(function(item) {
                    //                 items += (item.actual_weight ? '<li>' + item
                    //                     .actual_weight +
                    //                     '</li>' :
                    //                     '');
                    //             });
            ...
            $('body').on('click', '.deleteRelaxOut', function() {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "/delete/relaxout/" + request_id,
