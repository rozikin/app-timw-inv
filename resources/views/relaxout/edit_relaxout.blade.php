                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="container">
                                <form action="{{ route('update.relaxout', $relaxOut->id) }}" method="POST">
                                    @csrf
                                    <!-- Material IN Fields -->
                                    <div class="text-center">
                                        <h3>EDIT RELAX OUT</h3>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select form-select-sm" style="width: 100%;"
                                                        ...
                                                        <option value="CUTTING"
                                                            {{ $relaxOut->allocation == 'RELAX' ? 'selected' : '' }}>
                                                            RELAX</option>
                                                        <option value="DISPOSE"
                                                            {{ $relaxOut->allocation == 'DISPOSE' ? 'selected' : '' }}>
                                                            DISPOSE</option>
                                                        <option value="RETURN SUPPLIER"
                                                            {{ $relaxOut->allocation == 'RETURN SUPPLIER' ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="person" name="person" value="{{ $relaxOut->person }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="remark" name="remark" value="{{ $relaxOut->remark }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-bordered" id="details-table">
                                                    ...
                                                    <tbody id="details-containerx">
                                                        @foreach ($relaxOut->details as $index => $detail)
                                                            <tr>
                                                                <td><input type="text"
                                                                ...
                                                                <td><input type="text"
                                                                        ...
                                                                        class="form-control"
                                                                        value="{{ $detail->materialInDetail->received_date }}">
                                                                </td>
                                                                <td><input type="text"
