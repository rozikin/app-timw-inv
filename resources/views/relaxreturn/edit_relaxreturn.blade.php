                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="container">
                                <form action="{{ route('update.relaxreturn', $relaxReturn->id) }}" method="POST">
                                    @csrf
                                    <!-- Material IN Fields -->
                                    <div class="text-center">
                                        <h3>EDIT RELAX RETURN</h3>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row">
                                                <label for="material_in_no" class="col-sm-3 col-form-label">RELAX RETURN
                                                    No</label>
                                                <div class="col-sm-9">

                                                    <p>{{ $relaxReturn->relax_return_no }}</p>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <label for="fromx" class="col-sm-3  col-form-label">From</label>
                                                <div class="col-sm-9">
                                                    <select class="form-select form-select-sm" style="width: 100%;"
                                                        id="fromx" name="fromx">
                                                        <option value="RELAX"
                                                            {{ $relaxReturn->allocation == 'RELAX' ? 'selected' : '' }}>
                                                            RELAX</option>
                                                        <option value="DISPOSE"
                                                            {{ $relaxReturn->allocation == 'DISPOSE' ? 'selected' : '' }}>
                                                            DISPOSE</option>
                                                        <option value="RETURN SUPPLIER"
                                                            {{ $relaxReturn->allocation == 'RETURN SUPPLIER' ? 'selected' : '' }}>
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-bordered" id="details-table">
                                                    ...
                                                    <tbody id="details-containerx">
                                                        @foreach ($relaxReturn->details as $index => $detail)
                                                            <tr>
                                                                <td><input type="text"
