...
<link rel="stylesheet"
    href="{{ asset('backend/assets/vendors/datatables.net-bs5/buttons.bootstrap5.min.css') }}">
...
<link rel="stylesheet"
    href="{{ asset('backend/assets/vendors/sweetalert2/sweetalert2.min.css') }}">
...
{{-- <script src="{{ asset('backend/assets/js/dashboard-dark.js') }}">
</script> --}}
<script src="{{ asset('js/toastr.min.js') }}"></script>
<script src="{{ asset('backend/assets/vendors/datatables.net/jquery.dataTables.js') }}">
</script>
<script
    src="{{ asset('backend/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.js') }}">
</script>
<script src="{{ asset('backend/assets/vendors/datatables.net-bs5/jszip.min.js') }}"></script>
<script src="{{ asset('backend/assets/vendors/datatables.net-bs5/pdfmake.min.js') }}">
</script>
<script src="{{ asset('backend/assets/vendors/datatables.net-bs5/vfs_fonts.js') }}"></script>
{{-- <script src="{{ asset('backend/assets/vendors/datatables.net-bs5/buttons.html5.min.js') }}">
</script> --}}
{{-- <script src="{{ asset('backend/assets/vendors/datatables.net-bs5/buttons.print.min.js') }}">
</script> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                                ...
                                <form action="{{ route('store.materialout') }}" method="POST">
                                    ...
                                    {{-- <p class="text-danger">Add Purchase Request for CBD ID: {{ $cbdno }}
                                    </p> --}}
                                                ...
                                                <table class="table table-bordered" id="details-table">
                                                    ...
                                                    <tbody id="details-containerx">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="details[0][actual_weight]"
                                                                    class="form-control actual_weight"
                                                                    placeholder="ACTUAL WEIGHT"></td>
                                                            <td><input type="text" name="details[0][rak]"
                                                                    class="form-control rak" placeholder="RAK"></td>
                                                            ...
                                                            <td><input type="text" name="details[0][mo]"
                                                                    class="form-control mo" placeholder="MO"></td>
                                                            <td><input type="text" name="details[0][style]"
                                                                    class="form-control style" placeholder="STYLE">
                                                            </td>
                                                            <td><input type="text" name="details[0][rak_relax]"
                                                                    class="form-control rak_relax"
                                                                    placeholder="RAX RELAX"></td>
                                    ...
                                    <a href="{{ route('all.materialout') }}"
                                        class="btn btn-danger mt-2">Back</a>
                                </form>
                            </div>
        ...
        $(document).ready(function () {
            ...
            function add_row() {
               ...
               <tr>
                    ...
                    <td><input type="text" name="details[${rowIndex}][actual_weight]" class="form-control actual_weight" placeholder="ACTUAL WEIGHT"></td>
                    <td><input type="text" name="details[${rowIndex}][rak]" class="form-control rak" placeholder="RAK"></td>
                    ...
                    <td><input type="text" name="details[${rowIndex}][rek_relax]" class="form-control rak_relax" placeholder="RAK RELAX"></td>
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    if (response.material_in_detail) {
                                        ...
                                        row.find('input[name$="[receive_date]"]').val(
                                            response
                                            .material_in_detail.receive_date || '');
                                        row.find('input[name$="[supplier_name]"]').val(
                                            response
                                            .material_in_detail.supplier_name || '');
                                        row.find('input[name$="[item_code]"]').val(response
                                            .material_in_detail.item_code || '');
                                        ...
                                        row.find('input[name$="[roll]"]').val(response
                                            .material_in_detail.roll || '');
                                        row.find('input[name$="[gross_weight]"]').val(
                                            response
                                            .material_in_detail.gross_weight || '');
                                        row.find('input[name$="[net_weight]"]').val(response
                                            .material_in_detail.net_weight || '');
                                        row.find('input[name$="[qty]"]').val(response
                                            .material_in_detail.qty || '');
                                        row.find('input[name$="[basic_width]"]').val(
                                            response
                                            .material_in_detail.basic_width || '');
                                        row.find('input[name$="[basic_grm]"]').val(response
                                            .material_in_detail.basic_grm || '');
                                        row.find('input[name$="[mo]"]').val(response
                                            .material_in_detail.mo || '');
                                        row.find('input[name$="[actual_weight]"]').val(
                                            response
                                            .material_in_detail.actual_weight || '');
                                        row.find('input[name$="[rak]"]').val(response
                                            .material_in_detail.rak || '');
