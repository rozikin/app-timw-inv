        ...
        function (t, e, n) {
                        ...
                        this.channels[t] ||
                            (this.channels[t] = (function (t, e) {
                                if (0 === t.indexOf("private-encrypted-")) {
                                    if (e.config.nacl)
                                        return Ut.createEncryptedChannel(
                                            t,
                                            e,
                                            e.config.nacl
                                        );
            ...
            var ve = function (t, e, n, i, r, s) {
                    ...
                    return (
                        !(
                            (t.enabledTransports &&
                                -1 === U(t.enabledTransports, e)) ||
                            (t.disabledTransports &&
                                -1 !== U(t.disabledTransports, e))
                        )
                            ? ((r = Object.assign(
                ...
                constructor(t, e) {
                    !(function (t) {
                        ...
                        (this.config = (function (t, e) {
                            let n = {
                                activityTimeout:
                                    t.activityTimeout || s.activityTimeout,
                                cluster: t.cluster,
                        ...
                        this.config.enableStats &&
                            (this.timelineSender = Ut.createTimelineSender(
                                this.timeline,
                                {
